...
A Flask-based habit tracker with dark mode, badges, and analytics to help users build consistent routines.
...
🌐 Usage
- Open http://http://127.0.0.1:5000/habitsn Chrome (or whichever port you set in app.py).
